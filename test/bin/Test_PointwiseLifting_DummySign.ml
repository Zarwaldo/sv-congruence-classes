(* $Id: 85c103393a5b5f70c5e7411a8471cf2348587093 $ *)
...
let tests prefix =
  [
    ...
    prefix ^ ".post.top", test_post_top ;
    prefix ^ ".pre.bot", test_pre_bot ;
    prefix ^ ".pre.top", test_pre_top ;
  ]
end

(* This test suite. *)
let suite = ("PointwiseLifting (DummySign)", lazy (let open Make () in tests "pwlifting"))
