(* $Id: 2eff35fae81f1046e6cdc0ad1e90bc3346251272 $ *)
...
let test_empty () =
  ...
  assert_bool ~msg:"empty inf_to_m3" false (empty inf_to_m3) ;
...
(* This test suite. *)
let suite = ("DomInterval", lazy (let open Make () in tests "dominterval"))
