(* $Id: 709546aef8244f07253abf24f2045cd1bb1e2865 $ *)
...
(**
   ...
   In the implementation, abstract guards x ⋈ y, where ⋈ ∈ \{=, ≤\} and x, y are
   ...
   less precise than dedicated abstract guards x ⋈ y.  There are two reasons for
   choosing this approach despite the potential loss of precision.

   - Dedicated abstract guards would have to be performed and provided by the
